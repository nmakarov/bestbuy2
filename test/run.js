    ...
    if (status !== "success") {
        ...
        waitFor(function(){
            ...
            var exitCode = page.evaluate(function(){
                try {
                    console.log('');
                    console.log('Jasmine v', document.body.querySelector('span.version').innerText);
                    ...
                    if (list && list.length > 0) {
                      ...
                      for (i = 0; i < list.length; ++i) {
                          var el = list[i],
                              desc = el.querySelector('.description > a'),
                      ...
                      console.log(document.body.querySelector('div.alert').length);
                      return 0;
                    }
                } catch (ex) {
                    console.log(ex);
